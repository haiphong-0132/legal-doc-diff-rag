...
from src.core.matching.config import EMBEDDING_MODEL_DIR, RERANKER_MODEL_DIR, VB1_PATH, VB2_PATH, logger
from src.core.matching.helpers import build_embedding_results, embed_chunks, format_chunk, load_chunks
from src.core.matching.matching_review import (
...
def run_pipeline(vb1_path: str = VB1_PATH, vb2_path: str = VB2_PATH) -> Path:
    ...
    vb1_chunks = load_chunks(vb1_path)
    vb2_chunks = load_chunks(vb2_path)
